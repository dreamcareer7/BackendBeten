<ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
    ...
    @can('crew.index')
        <li class="nav-item">
            <a class="nav-link ajax" href="{{ route('dashboard.crew.index') }}"
               data-execute-after="assignDT('dataTable')">
                <svg class="nav-icon">
    ...
    @can('users.browse')
        <li class="nav-item">
            <a class="nav-link ajax" href="{{ route('dashboard.users.index') }}"
               data-execute-after="assignDT('dataTable')">
                <svg class="nav-icon">
    ...
    @can('services.index')
        <li class="nav-item">
            <a class="nav-link ajax" href="{{ route('dashboard.service.index') }}"
               data-execute-after="assignDT('dataTable')">
                <svg class="nav-icon">
    ...
    @can('vehicles.index')
        <li class="nav-item">
            <a class="nav-link ajax" href="{{ route('dashboard.vehicle.index') }}"
               data-execute-after="assignDT('dataTable')">
                <svg class="nav-icon">
    ...
    @can('groups.index')
        <li class="nav-item">
            <a class="nav-link ajax" href="{{ route('dashboard.group.index') }}"
               data-execute-after="assignDT('dataTable')">
                <svg class="nav-icon">
    ...
    @can('clients.index')
        <li class="nav-item">
            <a class="nav-link ajax" href="{{ route('dashboard.client.index') }}"
               data-execute-after="assignDT('dataTable')">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('icons/coreui.svg#cil-group') }}"></use>
                </svg>
    ...
    @can('documents.index')
        <li class="nav-item">
            <a class="nav-link ajax" href="{{ route('dashboard.document.index') }}"
               data-execute-after="assignDT('dataTable')">
                {{-- <svg class="nav-icon">
                    <use xlink:href="{{ asset('icons/coreui.svg#cil-documents') }}"></use>
                </svg> --}}
                <svg class="nav-icon" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
                     clip-rule="evenodd">
                    <path
    ...
    @can('contracts.index')
        <li class="nav-item">
            <a class="nav-link ajax" href="{{ route('dashboard.contract.index') }}"
               data-execute-after="assignDT('dataTable')">
                {{-- <svg class="nav-icon">
    ...
    @can('complaints.index')
        <li class="nav-item">
            <a class="nav-link ajax" href="{{ route('dashboard.complaint.index') }}"
               data-execute-after="assignDT('dataTable')">
                {{-- <svg class="nav-icon">
