...
<style>.actions {width: 5rem !important;} #dataTable1 TR TD {margin: 0px !important;padding: 0px !important;}</style>
    <div class="card mb-4">
        <div class="card-header">
		  <div class="d-flex justify-content-between">
            <div class="h5">Clients</div>
            <div class="title">{{ config('app.name') }}</div>
            <div class="actions">@can('users.create')<a class="btn btn-outline-success ajax" href="{{ route('dashboard.client.create') }}">Create</a> @endcan</div>
		  </div>
        </div>
	...
	<div class="card-body">
		<div class="table-responsive1">
			<table class="table table-border table-striped table-hover" aria-clickable="false" id="dataTable" data-dt-url="{{ route('dashboard.client.index') }}">
				<thead>
					<tr>
						<th data-column-name="fullname">Full Name</th>
						<th data-column-name="country_id">Country</th>
						<th data-column-name="id_type">ID Type</th>
						<th data-column-name="id_no">ID Number</th>
						<th data-column-name="gender">Gender</th>
						<th data-column-name="is_handicap">Is Handicap</th>
